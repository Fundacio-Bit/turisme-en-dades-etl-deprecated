const rows = 
{
    ...
    depesa_turistes_total:  { initRow: 61, numRows: 5 },
    despesa_turistes_total_acc:  { initRow: 69, numRows: 5 },
    pernoctacions:  { initRow: 77, numRows: 6 },
    pernoctacions_acc:  { initRow: 85, numRows: 6 },
    pernoctacions_per_illa:  { initRow: 93, numRows: 6 },
