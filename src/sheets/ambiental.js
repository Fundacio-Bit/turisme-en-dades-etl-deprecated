...
const energy_demand = (data, month) => {
    ...
    var dataObj = generate_json.getTableAcc(data, month, section, titleRow, columnRow, dataRows, true);
...
const human_pressure = (data, month) => {
    ...
    var dataObj = generate_json.getTableAcc(data, month, section, titleRow, columnRow, dataRows, false);
    request.makePost('http://54.77.111.120:5300', dataObj); 
}
